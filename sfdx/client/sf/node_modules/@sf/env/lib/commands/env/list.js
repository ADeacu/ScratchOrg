...
class EnvList extends sf_plugins_core_1.SfCommand {
    async run() {
        ...
        const tableOpts = {
            columns: (_a = this.flags.columns) === null || _a === void 0 ? void 0 : _a.join(','),
            csv: this.flags.csv,
    ...
    checkTableForNamedColumns(columns) {
        return Object.entries(columns).some(([, value]) => {
            var _a, _b;
            if ((_a = this.flags) === null || _a === void 0 ? void 0 : _a.columns) {
                return (_b = this.flags) === null || _b === void 0 ? void 0 : _b.columns.includes(value['header']);
            }
            return true;
        });
    }
