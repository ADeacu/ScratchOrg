...
class EnvOpen extends sf_plugins_core_1.SfCommand {
    ...
    async open(url, browser) {
        let options;
        if (browser) {
            if (browser === null || browser === void 0 ? void 0 : browser.toLowerCase().includes('chrome')) {
                browser = open.apps.chrome;
            }
            if (browser === null || browser === void 0 ? void 0 : browser.toLowerCase().includes('firefox')) {
                browser = open.apps.firefox;
            }
            if (browser === null || browser === void 0 ? void 0 : browser.toLowerCase().includes('edge')) {
