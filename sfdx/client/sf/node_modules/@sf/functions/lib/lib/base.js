...
class Command extends core_1.Command {
    async init() {
        await super.init();
        this.info = await core_2.GlobalInfo.getInstance();
    }
    get identityUrl() {
    ...
    get username() {
        var _a;
        return (_a = this.info.tokens.get(Command.TOKEN_BEARER_KEY)) === null || _a === void 0 ? void 0 : _a.user;
    }
    resetClientAuth() {
        delete this._auth;
        delete this._client;
    ...
    get auth() {
        ...
        if (!this._auth) {
            ...
            if (apiKey) {
                ...
                const token = (_a = this.info.tokens.get(Command.TOKEN_BEARER_KEY, true)) === null || _a === void 0 ? void 0 : _a.token;
                if (!token) {
