...
class Login extends base_1.default {
    async run() {
        ...
        this.info.tokens.set(base_1.default.TOKEN_BEARER_KEY, { token: bearerToken, url: this.identityUrl.toString() });
        await this.info.write();
        const account = await this.fetchAccount();
        this.info.tokens.update(base_1.default.TOKEN_BEARER_KEY, { user: account.salesforce_username });
        if (refreshToken) {
            this.info.tokens.set(base_1.default.TOKEN_REFRESH_KEY, {
                token: refreshToken,
